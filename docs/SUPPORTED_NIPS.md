...
| 59 | Gift wrap (verified wrap, seal, rumor ID, author, recipient binding, and unwrap provenance) | `~/code/nips/59.md` | `src/core/Nip59.ts`, `src/wrappers/nip59.ts` | `src/core/Nip59.test.ts` |
