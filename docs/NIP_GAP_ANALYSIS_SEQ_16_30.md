# Sequential NIP Gap Analysis — Batch 2: NIPs 16–30

**Date:** 2026-07-20  
**Series:** Sequential full-repo scan  
**Upstream:** `bdfa7e6` · **Repo:** (see git at commit time)  
**Prior:** `NIP_GAP_ANALYSIS_SEQ_01_15.md`
...
**Stale** vs July 2026 spec (subgroups, LiveKit, pins with `a`, metadata flag rename, moderation/join). Full matrix in `NIP_GAP_ANALYSIS_CORE_CHAT_REPUTATION.md` §2.2.
